...
@section('content')
    <div class="page-content-wrapper py-3">
        <div class="container">
            <div class="row gy-3">
                @if(count($myTitles))
                    @foreach($myTitles as $index => $title)
                        <div class="col-12">
                            <div class="single-vendor-wrap bg-img p-4 bg-overlay"
                                 style="background-image: url(' https://kultur.istanbul/gorsel/2020/05/kultur.istanbul-master-logo01.png')">
                                <h5 class="vendor-title text-white">{{$title}}</h5>
                                <div class="vendor-info">
                                    ...
                                    <div class="ratings lh-1">
                                        <span class="text-white">By {{ 'Kültür isatnbul' }}</span>
                                    </div>
                                </div>
                                <a class="btn btn-warning btn-sm mt-3" href="{{$myLinks[$index]}}">
                                    View
            ...
            <div class="row gy-3 " style="margin-top:1rem">
                @if(count($events))
